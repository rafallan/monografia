...
$selecionar = $mysqli->query("select * from autor order by nome");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        Você está em: <li class="active">Gerenciar Autores</li>

      </ol>

      <a href="cadastrar_autor.php" class="btn btn-primary" title="Adicionar novo">
...
$query = "Select * from autor order by nome limit {$por_pagina} offset {$offset}";
$resultado = mysqli_query($mysqli, $query);
?>

   		<h2 align="center">Gerenciar Autores</h2>
	...
	?>
            ...
            <tr>
              ...
              <td><a title="Editar" class="glyphicon glyphicon-edit" href="editar_autor.php?id=<?php echo $ih['id']; ?>"></a>
              / <a title="Excluir" class="glyphicon glyphicon-trash" href="excluir_autor.php?id=<?php echo $ih['id']; ?>" onclick="return confirm('Deseja excluir?');"></a></td>
            </tr>
	...
	?>
          ...
          <?php } else {?>
            <tr>
              <td colspan="2"><?php echo "Nenhum autor cadastrado"; ?></td>
            </tr>
